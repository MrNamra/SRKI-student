        ...
        <div class="lockscreen-item text-center" style="margin: 15px 0 0 0;">
            ...
            <form id="login" method="post" class="lockscreen-credentials">
                ...
                <div class="input-group mb-3" style="position: relative;">
                    ...
                    <button type="submit" class="btn" style="position: absolute; right: 10px; top: 50%; transform: translateY(-50%); background-color: #007bff; border-radius: 20px; border: none; z-index: 999999;"> <!-- Added z-index -->
